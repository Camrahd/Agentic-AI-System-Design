...
# STEP1. Load the codebase and create documents
...
# STEP3. Create embeddings and store in Chroma
...
# STEP4. Create a retrieval agent that uses the vector store to answer questions about the codebase
